...
Once the data linear (and therefore linearly separable), we can define our maximally marginal hyperplane. A general formual for the hyperplane is as follows
$$
W \times X + b = 0
$$
...
Age, gender, heart rate, systolic blood pressure, respiratory rate, and lactate level were utilized as predictors by the challenger. Once more, an SVM with a linear kernel was implemented for classification.
